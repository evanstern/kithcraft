...
Generated by grounding-wiki `scripts/capsules.mjs` at corpus commit 50c3def435dd9326d38e51118f08944815cbe80c.
...
- [[body-protocol-seam]] — the anti-corner move: world-agnostic perceive/act/remember; mod as first body vendor.
  The anti-corner architecture move — a world-agnostic body protocol (perceive / act / remember) between mind daemon and world, with the Minecraft mod as the first body vendor. Why minds never couple to Minecraft, what the seam buys, and how it constrained the mod-stack decision. Load for any protocol or architecture work (TASK-0002 especially).
