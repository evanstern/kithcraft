...
Generated by grounding-wiki `scripts/capsules.mjs` at corpus commit afd863f9f9a4bac161b10e191674cec7700ab7c4.
...
- [[overview]] — the project's shape: what Kithcraft is, what exists so far, where truth lives.
  The system's shape — what Kithcraft is (Minecraft mod giving the player LLM villagers as company), what exists at this stage (design artifacts, one ratified decision, PDLC machinery, and the first mind-daemon code), and where each kind of truth lives. Load first for orientation.
