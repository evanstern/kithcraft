...
| 2026-08-31 | TASK-0023 | — | — | — | in flight (lane 5 amendment, blocks TASK-0022 Phase 2; TASK-0022's own claim/staging rows ride its still-open branch): carded (27965ab, board-sync at root) per the operator's wire-first ruling; claimed (a77de94). Spec cycle next. |
